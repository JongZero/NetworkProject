...
void ColliderBox::Draw()
{
	...
	if (IsCollided)
	{
		JJEngine::GetInstance()->DrawFillRectangle(SetTransform.Pos.x, SetTransform.Pos.y, SetTransform.Pos.x + SetTransform.Size.x, SetTransform.Pos.y + SetTransform.Size.y, ColorF(ColorF::DarkGray));
	}
	else
	{
		JJEngine::GetInstance()->DrawFillRectangle(SetTransform.Pos.x, SetTransform.Pos.y, SetTransform.Pos.x + SetTransform.Size.x, SetTransform.Pos.y + SetTransform.Size.y, ColorF(ColorF::Black));
	}
...
{
	// 자신의 이름 출력
	JJEngine::GetInstance()->DrawText(SetTransform.Pos.x, SetTransform.Pos.y + SetTransform.Size.y / 2, 30, ColorF(ColorF::White), Name.c_str());
}
